  ...
  app.get("/api/dashboard/well-data", async (req, res) => {
    try {
      ...
      const wellData: any = {
        ...
        motorFail: motorData.motorFail || bhaHeader.motorFail === true,
        mwdFail: motorData.mwdFail || bhaHeader.mwdFail === true,
        pooh: motorData.pooh || wellRunData.pooh || bhaHeader.pooh || bhaHeader.reasonPOOH || '',
        mwdComments: motorData.mwdComments || wellRunData.mwdComments || bhaHeader.mwdComments || '',
        pw: safeInt(bhaDetails.pw || bhaHeader.pw),
        ssq: safeInt(motorData.ssq || wellRunData.ssq || bhaHeader.ssq),
        tfsq: safeInt(motorData.tfsq || wellRunData.tfsq || bhaHeader.tfsq),
        crossover: safeInt(motorData.crossover || wellRunData.crossover || bhaHeader.crossover),
        gcf: safeInt(bhaDetails.gcf || bhaHeader.gcf),
        dao: safeInt(motorData.dao || wellRunData.dao || bhaHeader.dao),
        surfaceSystemVersion: safeInt(motorData.surfaceSystemVersion || wellRunData.surfaceSystemVersion || bhaHeader.surfaceSystemVersion),
        ...
        lih: motorData.lih || wellRunData.lih || bhaHeader.lih === true,
        stalls: safeInt(motorData.stalls || wellRunData.stalls || bhaHeader.stalls),
        npt: safeNumber(motorData.npt || wellRunData.npt || bhaHeader.npt),
        mwdCoordinator: bhaDetails.mwdCoordinator || bhaHeader.mwdCoordinator || '',
        directionalCoordinator: bhaDetails.directionalCoordinator || bhaHeader.directionalCoordinator || '',
        ddLead: motorData.ddLead || wellRunData.ddLead || bhaHeader.ddLead || '',
        mwdLead: motorData.mwdLead || wellRunData.mwdLead || bhaHeader.mwdLead || '',
        ...
        mwdMinTemp: safeNumber(motorData.mwdMinTemp || wellRunData.mwdMinTemp || bhaHeader.mwdMinTemp),
        mwdMaxTemp: safeNumber(motorData.mwdMaxTemp || wellRunData.mwdMaxTemp || bhaHeader.mwdMaxTemp),
