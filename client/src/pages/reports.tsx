...
export default function ReportsPage({ selectedWell }: ReportsPageProps) {
  ...
  const generateExcel = async (componentType: string) => {
    // Use well selected from wells page and selected run from dropdown
    ...
    try {
      ...
      const response = await fetch(
        `/api/component-report/${wellId}/${selectedRunId}/${componentType}`,
        { credentials: "include" }
      );
              ...
              {componentButtons.map((component) => {
                ...
                return (
                  <Button
                    ...
                    disabled={!wellId || !selectedRunId || generatingReport !== null}
